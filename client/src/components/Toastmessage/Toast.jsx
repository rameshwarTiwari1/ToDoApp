...
// Toast notification implementation and toast bg color text etc configuration
const Toast = ({isShown,message,type,onClose}) => {
  useEffect(() => {
    // time out os toast notification on browser after
  ...
  return (
    ...
    <div className={`w-10 h-10 flex items-center justify-center rounded-full ${
      type==="delete"?"bg-red-50":"bg-greeen-50"
    }`}>
